    ...
    private JPanel initInfoPanel() {
        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(kmax<=0)
                    JOptionPane.showMessageDialog(Fenetre.this, "Kmax invalide, veuillez choisir un kmax strictement positif");
                else{ 
                ...
                switch (fileType) {
                    ...
                    case "flights":
                        if(airportsFilePath.equals("")){
                            JOptionPane.showMessageDialog(Fenetre.this, "Le fichier des aéroports n'est pas défini");//marche pas
        ...
        affichervols.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                if(flightsFilePath.equals("")){
                    JOptionPane.showMessageDialog(Fenetre.this, "Le fichier des vols n'est pas chargé");
                     }
                else{
                    tabvols = new ArrayList<>(Arrays.asList(vols));
                    for(Vol v: tabvols){
                    modelevol.removeVol(v);
                        }
                    for(Vol v: tabvols){
                        modelevol.addVol(v);
                        }
                    volPanel = new JPanel();
                    tablevols=new JTable(modelevol);
